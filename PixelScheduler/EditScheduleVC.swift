...
class EditScheduleVC: UITableViewController
//, PlaySoundEffect
{
...
//				playSound(AVAudioPlayer.write)
				...
				if toEdit != nil{
					newSchedule.copyCompleteHistory(from: toEdit!)
		...
		showAlertForDismiss(title: "새로운 일정 등록 실패", message: message, with: settingController.visualMode)
	}

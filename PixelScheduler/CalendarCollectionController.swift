...
protocol CalendarCollectionController: UICollectionViewDelegate & UICollectionViewDelegateFlowLayout & UICollectionViewDataSource {
...
extension CalendarCollectionController {
    func drawCellForCalendar(_ cell: CalendarCell, at indexPath: IndexPath, calendarView: UICollectionView, with palette: SettingController.ColorPalette) -> CalendarCell {
    ...
    func drawCellForWeeklyView(_ cell: WeeklyCell, at indexPath: IndexPath, calendarView: UICollectionView, with palette: SettingController.ColorPalette) -> WeeklyCell  {
        let dateInt = squaresInCalendarView[indexPath.item]!
        // toss date to cell

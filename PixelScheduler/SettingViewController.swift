...
class SettingViewController: UITableViewController, PlaySoundEffect {
    ...
    @objc private func selectVisualMode(sender: UISegmentedControl) {
        let selectedMode: SettingController.VisualMode
    ...
    @objc private func selectHapticMode(sender: UISegmentedControl) {
        ...
        let selectedMode: SettingController.HapticMode
        switch sender.selectedSegmentIndex {
        case 0:
            selectedMode = .weak
        case 1:
    ...
    @IBAction func selectDateLanguage(_ sender: UISegmentedControl) {
        let selectedLanguage: SettingController.DateLanguage
        switch sender.selectedSegmentIndex {
        case 0:
    ...
    @IBAction func selectIcloudBackup(_ sender: UISegmentedControl) {
        let newState: SettingController.ICloudBackup = sender.selectedSegmentIndex == 0 ? .on : .off
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let colorIndex =  SettingController.ColorPalette.allCases.firstIndex(of: settingController.palette)!
    ...
    private func updatePalettePreview(with palette: SettingController.ColorPalette) {
...
extension SettingViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        SettingController.ColorPalette.allCases.count
    }
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        let pickedPalette = SettingController.ColorPalette.allCases[row]
